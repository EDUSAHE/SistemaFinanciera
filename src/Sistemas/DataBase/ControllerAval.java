...
//-----------------------------------------------------------------------------METODOS-Aval-------------------------------------------------------------------------------\\
       ...
       public  ResultSet ConsultarAval(int IdAval) throws SQLException{
        ...
        public  ResultSet CrearAval(int IdCliente,String Nombre,String ApellidosP,String ApellidoM,String Direccion,String TelefonoCelular,String TelefonoCasa,String DireccionEmpleo,String Referencia){
           Conexion conexion =new Conexion();
            Connection con = conexion.conectar();
           ResultSet rs = null;
           try{
               //escribimos la consulta en sql
               PreparedStatement ps= con.prepareStatement("INSERT INTO AVAL (Nombre,ApellidosP,ApellidoM,Direccion,TelefonoCelular,TelefonoCasa,DireccionEmpleo,Referencia,IdCliente) VALUES(?,?,?,?,?,?,?,?,?)");
        ...
        public  int ActualizarAval(int IdAval,int IdCliente,String Nombre,String ApellidosP,String ApellidoM,String Direccion,String TelefonoCelular,String TelefonoCasa,String DireccionEmpleo,String Referencia){
           Conexion conexion =new Conexion();
            Connection con = conexion.conectar();
           
           try{
               //escribimos la consulta en sql
               PreparedStatement ps= con.prepareStatement("UPDATE Aval SET Nombre=?,ApellidosP=?,ApellidoM=?,Direccion=?,TelefonoCelular=?,TelefonoCasa=?,DireccionEmpleo=?,Referencia=? ,IdCliente=? WHERE IdAval=?");
